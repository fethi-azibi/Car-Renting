"""
Django settings for carRenting project.
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'carRenting/static'),
]
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'abdouazibi484@gmail.com'
EMAIL_HOST_PASSWORD = 'lpunppqmwogerhke'
EMAIL_USE_TLS = True
import _locale
